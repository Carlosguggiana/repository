...
public class ServletTela2Cadastro extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        resposta.write("<br/>");
        resposta.write(request.getParameter("Rua da Empresa"));
        resposta.write("<br/>");
        resposta.write(request.getParameter("Complemento da Empresa"));
        resposta.write("<br/>");
        resposta.write(request.getParameter("Cidade da Empresa"));
        resposta.write(", ");
        resposta.write(request.getParameter("Cep da Empresa"));
        resposta.write(", ");
        resposta.write(request.getParameter("Estado da Empresa"));
